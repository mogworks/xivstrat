 ...
 *
 * Processes all JavaScript files in the public_scripts directory,
...
import { colors, formatSize, log, logError, logGroup, logSuccess } from './logger.js'

// Get current directory and relevant paths
const __dirname = path.dirname(fileURLToPath(import.meta.url))
const scriptsDir = path.resolve(__dirname, '../src/public_scripts')
