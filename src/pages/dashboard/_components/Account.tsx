...
import { emailSchema, passwordSchema, type User } from '@/auth/schema'
...
import { PasswordInput } from '@/pages/dashboard/_components/PasswordInput'
...
export default function Account({ user }: { user: User }) {
  ...
  return (
    <div className="w-full p-16 max-w-xl mx-auto">
      <div className="w-full relative rounded-xl mx-auto">
        <GlowEffect />
        <Card>
          <CardContent>
